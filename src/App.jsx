  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem){
        return <div>
             <Card company={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} />       <Card company={elem.companyName} datePosted={elem.datePosted}  />
        </div>
      })}
